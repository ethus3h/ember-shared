...
(define-public ddc-common-attributes
    (package
        ...
        (version "1.1.4.585-e853d5e0c77cf1f23ce2f3a3b11712cd32fd0e8f")
        (build-system trivial-build-system)
        (source (origin
            (method git-fetch)
            (uri (git-reference
                (url "https://github.com/ethus3h/ember-information-technology-environment.git")
                (commit "e853d5e0c77cf1f23ce2f3a3b11712cd32fd0e8f")))
            (sha256
            (base32
                "055kb4j58c4aaq5xl8qvhi1h1sri8bazl0x0lflr4dkq5b592yyr"))
...
(define-public ddc-common-attributes-slow
    (package
        ...
        (version "1.1.4.585-71cba4edd92a0b10cffe30afd10f707ae3b8166f")
        (source (origin (inherit (package-source ddc-common-attributes))
            (uri (git-reference
                (url "https://github.com/ethus3h/ember-information-technology-environment.git")
                (commit "71cba4edd92a0b10cffe30afd10f707ae3b8166f")))
            (sha256
            (base32
                "1wnpz8yfajpw522iqnx5ghyjb04mncnx0xq8ia9cwznvp42ww72g"))
        ))
    )
)
