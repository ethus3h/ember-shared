...
(define-public ddc-common-attributes
    (package
        ...
        (version "1.1.4.585-8a0bd0946fe44626c585e90305892d0d6888e90d")
        (build-system trivial-build-system)
        (source (origin
            (method git-fetch)
            (uri (git-reference
                (url "https://github.com/ethus3h/ember-information-technology-environment.git")
                (commit "8a0bd0946fe44626c585e90305892d0d6888e90d")))
            (sha256
            (base32
                "13i9h7zlzvg8fqc6w729lblpwdy4haqafqhphq00j6d1cd28yssn"))
...
(define-public ddc-common-attributes-slow
    (package
        ...
        (version "1.1.4.585-d9783c5ce5694a848ad1aa7d04b7a91f0e53cfa6")
        (source (origin (inherit (package-source ddc-common-attributes))
            (uri (git-reference
                (url "https://github.com/ethus3h/ember-information-technology-environment.git")
                (commit "d9783c5ce5694a848ad1aa7d04b7a91f0e53cfa6")))
            (sha256
            (base32
                "12xzr6cxrvy9198b7khbrvby0xpa9bm0npnksqjzwmsn5k62az6n"))
        ))
    )
)
