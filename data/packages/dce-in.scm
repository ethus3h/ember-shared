  ...
  (package
    ...
    (source (origin
                ...
                (snippet '(begin
                    ...
                    (for-each delete-file-recursively (for-each find-files (for-each find-files (find-files "tests/stagel")) "run") ; "run" folders hold the generated output, while "out" folders hold the expected output
                    #t
                ))
        )
    )
