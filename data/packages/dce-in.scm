  ...
  (package
    ...
    (source (origin
                ...
                (snippet '(begin
                    ...
                    (for-each delete-file-recursively find-files (for-each find-files (for-each find-files (find-files "tests/stagel"))) ; "run" folders hold the generated output, while "out" folders hold the expected output
                    #t
                ))
        )
    )
