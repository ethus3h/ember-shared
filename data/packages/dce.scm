...
(define-public ember-shared-core
  (package
    ...
    (version "1.1.4.522-9905692bdf5d8592c1d376dc67ee92e79134c936")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "9905692bdf5d8592c1d376dc67ee92e79134c936")))
              (sha256
               (base32
                "0gbqjkcj2ic2l4l06r73b5x4a5d60gx6r0wad59m0fr6hz40vrz4"))))
    (build-system gnu-build-system)
...
(define-public ember-shared-main
  (package
    ...
    (version "1.1.4.522-c7435d9ce6bc57dd9f231f3a115a1d96239eb591")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "c7435d9ce6bc57dd9f231f3a115a1d96239eb591")))
              (sha256
               (base32
                "1ysagbcbk1jmbq0la4h2mzrqwbrmagmqxid5wlw5dmgppqyp4vxi"))))
    (build-system gnu-build-system)
...
(define-public ember-shared-extra
  (package
    ...
    (version "1.1.4.522-b9045ea3cd66cc656a46568121406fe8ea4537be")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "b9045ea3cd66cc656a46568121406fe8ea4537be")))
              (sha256
               (base32
                "0vjgns9mcm93ln3kwira4saxbmakixdjm541hm3kcm3ahw9m3iw2"))))
    (build-system gnu-build-system)
...
(define-public dce-common-attributes
        (package
            ...
            (version "0-72d2810a9a2dd916e307fd78587d723dddc31621")
            (build-system trivial-build-system)
            (source (origin
                (method git-fetch)
                (uri (git-reference
                    (url "https://github.com/ethus3h/ember-information-technology-environment.git")
                    (commit "72d2810a9a2dd916e307fd78587d723dddc31621")))
                (sha256
                (base32
                    "0g1ifzjb80c993jl2qcg0xvyr3y3lyrag8kg2k62qm80i1w7i6hr"))
