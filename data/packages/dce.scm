...
(define-public ember-shared-error-notify
  (package
    ...
    (version "1.1.4.526-753dfc57a9a8fc9428518ddcc7d092cfe8ed47e6")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "753dfc57a9a8fc9428518ddcc7d092cfe8ed47e6")))
              (sha256
               (base32
                "14crgi581hxvmhsvq98h1cnsrcg075y5h6ibkmr0ark5gz04mwdx"))))
...
(define-public ember-shared-core
  (package
    ...
    (version "1.1.4.526-efa43dd765d6664723242ece4d8a1644a4b3d708")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "efa43dd765d6664723242ece4d8a1644a4b3d708")))
              (sha256
               (base32
                "0n65hvhgzy9rs0zhlwyzh49z7c52b238d19r9fggd97wf8q438mw"))))
    (build-system gnu-build-system)
...
(define-public ember-shared-main
  (package
    ...
    (version "1.1.4.526-dba5ff9db0a02b4049d8a5207944f740305ca043")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "dba5ff9db0a02b4049d8a5207944f740305ca043")))
              (sha256
               (base32
                "0zmzx3iq831yah7pkcp1bbrnk53fh77c62fp3zz75ml0ch5pqw8n"))))
    (build-system gnu-build-system)
...
(define-public ember-shared-extra
  (package
    ...
    (version "1.1.4.526-b391ca41b6e4b12fe7872752403c1a91ea863f57")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "b391ca41b6e4b12fe7872752403c1a91ea863f57")))
              (sha256
               (base32
                "0iy4rddryr6q8kixd5mrah3anwp4v5r30h8lfclzs1zqjvcr57my"))))
    (build-system gnu-build-system)
...
(define-public dce-common-attributes
        (package
            ...
            (version "0-457e22cb55cd079b8733d98adc7101d787f9f707")
            (build-system trivial-build-system)
            (source (origin
                (method git-fetch)
                (uri (git-reference
                    (url "https://github.com/ethus3h/ember-information-technology-environment.git")
                    (commit "457e22cb55cd079b8733d98adc7101d787f9f707")))
                (sha256
                (base32
                    "0h1gvhx6cxqklv9lf2387x1kqqjhcp7gpwcj9b9v3lddv6fg7s4s"))
