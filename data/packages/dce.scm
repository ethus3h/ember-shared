...
(define-public ember-shared-error-notify
  (package
    ...
    (version "1.1.4.524-a06405a3f356e5652e6b3f682a7a0a9d0a4e6d30")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "a06405a3f356e5652e6b3f682a7a0a9d0a4e6d30")))
              (sha256
               (base32
                "1i193ix3m79ca4il6n358xinrlkrri2c2xmav0ywz9l87kr07hbx"))))
...
(define-public ember-shared-core
  (package
    ...
    (version "1.1.4.524-38620a077cf98fed759424c86e105a4ca0e168db")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "38620a077cf98fed759424c86e105a4ca0e168db")))
              (sha256
               (base32
                "17vc3yw7npr4fdxxdrx9zh6bk4iilxpw8braq1254xijja7z3r3i"))))
    (build-system gnu-build-system)
...
(define-public ember-shared-main
  (package
    ...
    (version "1.1.4.524-920d73d2a5bb3c53a4bf4cc3c8c70c2b397e047b")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "920d73d2a5bb3c53a4bf4cc3c8c70c2b397e047b")))
              (sha256
               (base32
                "1vh46gcpvr6wvqm1bvls6z8nl8vqvshqkvaa0figz83ahh2p895i"))))
    (build-system gnu-build-system)
...
(define-public ember-shared-extra
  (package
    ...
    (version "1.1.4.523-5d8c74cc0cfbe227036137c8bfac71aa7286cff0")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "5d8c74cc0cfbe227036137c8bfac71aa7286cff0")))
              (sha256
               (base32
                "0l0i2i15ghy8cym81ba1dbinp7arvfiyh267dzr5hb3cbzvbi3j0"))))
    (build-system gnu-build-system)
...
(define-public dce-common-attributes
        (package
            ...
            (version "0-7a26f78b1f28e3004ee829b5eb1a00b4fdb22bb6")
            (build-system trivial-build-system)
            (source (origin
                (method git-fetch)
                (uri (git-reference
                    (url "https://github.com/ethus3h/ember-information-technology-environment.git")
                    (commit "7a26f78b1f28e3004ee829b5eb1a00b4fdb22bb6")))
                (sha256
                (base32
                    "0ibsn2yk84g7d1az4rd5cbsd1k38knf7fnzpdwbav14m4jn32d5z"))
