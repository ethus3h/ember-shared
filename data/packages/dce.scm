...
(define-public ember-shared-error-notify
  (package
    ...
    (version "1.1.4.512-6cb3ffbebad66d4958e2386ea2daab8661a2539f")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "6cb3ffbebad66d4958e2386ea2daab8661a2539f")))
              (sha256
               (base32
                "0m87x337yy80gym4fzq29lvinivbzlyyg665gh4ba9f0sarpysd9"))))
...
(define-public ember-shared-core
  (package
    ...
    (version "1.1.4.512-6d3dc5636b3205792d5812455a1c69f7263d6a21")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "6d3dc5636b3205792d5812455a1c69f7263d6a21")))
              (sha256
               (base32
                "1nnfb0mcjd84jhfddinj62zjgn610150xvg9l8firapw0qwddwml"))))
    (build-system gnu-build-system)
...
(define-public ember-shared-main
  (package
    ...
    (version "1.1.4.512-918a3ccc56601ef6b0e1ee041b39fc56f57b4740")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "918a3ccc56601ef6b0e1ee041b39fc56f57b4740")))
              (sha256
               (base32
                "0zsdha19lp0y9y96dkzlpmlz3wbivcj571yk5rr2lxvvm3jnqf1g"))))
    (build-system gnu-build-system)
...
(define-public ember-shared-extra
  (package
    ...
    (version "1.1.4.510-983f5b0bd2369eca5f9ee7760b5505b173f95089")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "983f5b0bd2369eca5f9ee7760b5505b173f95089")))
              (sha256
               (base32
                "1hw86flpa8z6smv2ndjxgrpsa7bqi68y4v5r811x74ydfva43l2a"))))
    (build-system gnu-build-system)
...
(define-public crystallize
  (package
    (name "crystallize")
    (version "0-e03de38f20cc4c0f226b57c8c5df8233a5a2b7c5")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/crystallize.git")
                (commit "e03de38f20cc4c0f226b57c8c5df8233a5a2b7c5")))
              (sha256
               (base32
                "126d9bv822c5lm5qqrakxzvnj8kw7gw0cx20vaw5lqvirsxxhmzr"))))
    (build-system gnu-build-system)
    (propagated-inputs `(
