...
(define-public ember-shared-core
  (package
    ...
    (version "1.1.4.497-8e6be44086462263ec3673ea22ac8a554c793fbb")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "8e6be44086462263ec3673ea22ac8a554c793fbb")))
              (sha256
               (base32
                "0al6dibn3bkl18qaapa5jk5plmwg8nkzfarrfvv149hjdq59xhh3"))))
    (build-system gnu-build-system)
...
(define-public ember-shared-main
  (package
    ...
    (version "1.1.4.497-f5d147b0e8bb76bed517885d2dec72cfb0bef5c1")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "f5d147b0e8bb76bed517885d2dec72cfb0bef5c1")))
              (sha256
               (base32
                "0y5ycnm8fyaxj9zc29ncck1mys0529az5lvb3yzwlijm7m02lh4m"))))
    (build-system gnu-build-system)
...
(define-public ember-shared-extra
  (package
    ...
    (version "1.1.4.497-9d7b738187b52a261fd935d611aadd600d67e9ba")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "9d7b738187b52a261fd935d611aadd600d67e9ba")))
              (sha256
               (base32
                "0iqnx14s69vdr0vmy3mavah1dbmnrwk319wb59z5nqs2zj2s764f"))))
    (build-system gnu-build-system)
