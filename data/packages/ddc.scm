...
(define-public ember-shared-error-notify
  (package
    ...
    (version "1.1.4.533-8ec4d2c552fbb5f8349654653060d1b6b6e1b405")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "8ec4d2c552fbb5f8349654653060d1b6b6e1b405")))
              (sha256
               (base32
                "1jk1mqxg2k68fbgw73pkz4rh99i7cax4cmj191gixqhwac47lkgi"))))
...
(define-public ember-shared-core
  (package
    ...
    (version "1.1.4.533-ca1e1bcd459215371a6a79a2f5754a19e8f0f224")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "ca1e1bcd459215371a6a79a2f5754a19e8f0f224")))
              (sha256
               (base32
                "0i2d6jjjq8h8kygpd4qavk3c3888s32qwifr76vhk7r9kiv3dlsl"))))
    (build-system gnu-build-system)
...
(define-public ember-shared-main
  (package
    ...
    (version "1.1.4.533-4194f47684e47ca9459188e9def7c8f53c194ba6")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "4194f47684e47ca9459188e9def7c8f53c194ba6")))
              (sha256
               (base32
                "1hj1hnc4r49if3af4s0gpp5zjpb11pzbyrcrz3apmbi10qdcflsv"))))
    (build-system gnu-build-system)
...
(define-public ddc-common-attributes
        (package
            ...
            (version "0-675fdfe7683920140b23d2f6c6e9e6d3b7bb1e64")
            (build-system trivial-build-system)
            (source (origin
                (method git-fetch)
                (uri (git-reference
                    (url "https://github.com/ethus3h/ember-information-technology-environment.git")
                    (commit "675fdfe7683920140b23d2f6c6e9e6d3b7bb1e64")))
                (sha256
                (base32
                    "1iw7636rrac09r2rmcyrr5w31yygkfxascxsk0s0qn04vg8mb204"))
