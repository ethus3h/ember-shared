...
(define-public ember-shared-error-notify
  (package
    ...
    (version "1.1.4.536-0a67097deffd0aaf7f96b04590788a0de94910db")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "0a67097deffd0aaf7f96b04590788a0de94910db")))
              (sha256
               (base32
                "178varsghsp9ypbrf0kh78r12g1m7lnnn7b7mjd7awbf0b4bx408"))))
...
(define-public ember-shared-core
  (package
    ...
    (version "1.1.4.536-0bf4b9826ecef56c93d5673805a3cd6e423d5759")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "0bf4b9826ecef56c93d5673805a3cd6e423d5759")))
              (sha256
               (base32
                "1n0mflrbcpn26ccv7k7dy8hdrnz0rhn1d833syw1w9lgmsh844qz"))))
    (build-system gnu-build-system)
...
(define-public ember-shared-main
  (package
    ...
    (version "1.1.4.536-4059a76ce1880142bdbd76b3583e231d9f9b5a1a")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "4059a76ce1880142bdbd76b3583e231d9f9b5a1a")))
              (sha256
               (base32
                "0nhm9nr31v3999ypgzm0grni6nqaj3wrmcjz3si5m24dkllcsg95"))))
    (build-system gnu-build-system)
...
(define-public ember-shared-extra
  (package
    ...
    (version "1.1.4.536-f60e168345abe9c264535e1aec5dd34b0cf31091")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "f60e168345abe9c264535e1aec5dd34b0cf31091")))
              (sha256
               (base32
                "0rzlzsj09hsf94r8y6a3d6v5hmp9pb4yhldib5v3xdkrh8yxfmiv"))))
    (build-system gnu-build-system)
...
(define-public ddc-common-attributes
        (package
            ...
            (version "0-f4222425b469cc96b1a13a7da927c6228f68415c")
            (build-system trivial-build-system)
            (source (origin
                (method git-fetch)
                (uri (git-reference
                    (url "https://github.com/ethus3h/ember-information-technology-environment.git")
                    (commit "f4222425b469cc96b1a13a7da927c6228f68415c")))
                (sha256
                (base32
                    "157ncr5qw334bx8zm41459a2yx4izn59c3l89wfcpnqr2bhb31n3"))
