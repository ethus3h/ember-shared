...
(define-public ember-shared-error-notify
  (package
    ...
    (version "1.1.4.532-bfa26d0a180cbabdbbb59829ad4847958edfd432")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "bfa26d0a180cbabdbbb59829ad4847958edfd432")))
              (sha256
               (base32
                "055b0k4bygqg9kr7fhbbqqri7lldwn519x5fhf2djfkbqagjgj3a"))))
...
(define-public ember-shared-core
  (package
    ...
    (version "1.1.4.532-f7c68f59c86943e8f8c5a6136cf78e646bd1ab29")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "f7c68f59c86943e8f8c5a6136cf78e646bd1ab29")))
              (sha256
               (base32
                "09la13h6brxfp3pqlaj72r7zzfb0bxaiq4a72shbczvlg9lsfbir"))))
    (build-system gnu-build-system)
...
(define-public ember-shared-main
  (package
    ...
    (version "1.1.4.531-fb71fe8043797455ac69b1d66203c5fa5f1806d6")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "fb71fe8043797455ac69b1d66203c5fa5f1806d6")))
              (sha256
               (base32
                "110z7kdlhwcwnjb0vp4qai75ly58pg633kpgqjrz07wixxb5n2p1"))))
    (build-system gnu-build-system)
...
(define-public ember-shared-extra
  (package
    ...
    (version "1.1.4.531-c57eeda6a0ad63d5a998250cba845bb05d83626e")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "c57eeda6a0ad63d5a998250cba845bb05d83626e")))
              (sha256
               (base32
                "1f0wb1j26cf9qbq2480rn5vckmmhi7zcvmvlmp1ci8gnghg18ix7"))))
    (build-system gnu-build-system)
...
(define-public ddc-common-attributes
        (package
            ...
            (version "0-17c83d695f649178c2ca7f72f5266f8279eccf9f")
            (build-system trivial-build-system)
            (source (origin
                (method git-fetch)
                (uri (git-reference
                    (url "https://github.com/ethus3h/ember-information-technology-environment.git")
                    (commit "17c83d695f649178c2ca7f72f5266f8279eccf9f")))
                (sha256
                (base32
                    "0sikwb7fkgps1086szyan2w9mpryb0qq2590wq4gzlvh2bi6wzv6"))
