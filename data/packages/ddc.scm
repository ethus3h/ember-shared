...
(define-public ember-shared-error-notify
  (package
    ...
    (version "1.1.4.587-d7aab9e67f39686a6cebb50525e1600233e060fe")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "d7aab9e67f39686a6cebb50525e1600233e060fe")))
              (sha256
               (base32
                "1x9smjj23vnmabifn5rj7pwb735xm6k3j057lsa5440vfm42c4mw"))))
...
(define-public ember-shared-core
  (package
    ...
    (version "1.1.4.587-fda03d6ed1ea442a75f3d3b2b82a4499141f6236")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "fda03d6ed1ea442a75f3d3b2b82a4499141f6236")))
              (sha256
               (base32
                "0a106gswy6dn0hnay97ypx9zy93hnm7rl2iak54l504h801s6igc"))))
    (build-system gnu-build-system)
...
(define-public ember-shared-main
  (package
    ...
    (version "1.1.4.587-a486fd9a830b6fec9c8aee03fda69fcb35e038c1")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "a486fd9a830b6fec9c8aee03fda69fcb35e038c1")))
              (sha256
               (base32
                "0aj7l3kldd9216h0f8kaprkyi27rgp6bhqqy1y2m11rkrj7ff1q1"))))
    (build-system gnu-build-system)
...
(define-public ember-shared-extra
  (package
    ...
    (version "1.1.4.587-043a570cd7e588f4a5da6cfbd49362366a2b6ffc")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "043a570cd7e588f4a5da6cfbd49362366a2b6ffc")))
              (sha256
               (base32
                "1bs5nnxsvn12h84vls8b8fyjaqvh2x70yy4iw2v8zss6xxwq2vhm"))))
    (build-system gnu-build-system)
...
(define-public crystallize
  (package
    (name "crystallize")
    (version "3.1.2.5.14.403-96330fc92525661d59033f1c676d512bb13d2e58")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/crystallize.git")
                (commit "96330fc92525661d59033f1c676d512bb13d2e58")))
              (sha256
               (base32
                "1m7jrpgzw0wk5zpwn8a6b65vl6d7fvzzivm0bxryqs2ghzni1ax0"))))
    (build-system gnu-build-system)
    (propagated-inputs `(
...
(define-public ddc-common-attributes
    (package
        ...
        (version "1.1.4.587-ceebe749588dae1afc579e8b23bea6e2e4c3fb18")
        (build-system trivial-build-system)
        (source (origin
            (method git-fetch)
            (uri (git-reference
                (url "https://github.com/ethus3h/ember-information-technology-environment.git")
                (commit "ceebe749588dae1afc579e8b23bea6e2e4c3fb18")))
            (sha256
            (base32
                "0jilvim1lr15ih59bfyz8x3wsfsncc5gr3siflvrldbhd5fnqwn1"))
...
(define-public ddc-common-attributes-slow
    (package
        ...
        (version "1.1.4.587-608b3c2381c7ff2435d7527886a49ca91aaf446f")
        (source (origin (inherit (package-source ddc-common-attributes))
            (uri (git-reference
                (url "https://github.com/ethus3h/ember-information-technology-environment.git")
                (commit "608b3c2381c7ff2435d7527886a49ca91aaf446f")))
            (sha256
            (base32
                "0hfxnfbfwbar6dgn5x7wpxj292336vivdm59zwxdvw29y6cpr7am"))
        ))
    )
)
