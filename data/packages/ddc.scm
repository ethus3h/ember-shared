...
(define-public ember-shared-main
  (package
    ...
    (version "1.1.4.532-69018f635cdbfbcc231828516518ed54d46bfaf1")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "69018f635cdbfbcc231828516518ed54d46bfaf1")))
              (sha256
               (base32
                "1rwixanmkl96j2v3fzxbb07ww32kak31ny1iwqzdsp1sq8illlim"))))
    (build-system gnu-build-system)
...
(define-public ember-shared-extra
  (package
    ...
    (version "1.1.4.532-0f9259e08c75b5f1aef1207110d58f12502cb1e4")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "0f9259e08c75b5f1aef1207110d58f12502cb1e4")))
              (sha256
               (base32
                "0fjkzisaj4zfb2nv05dpninxwa3mcp4c4cs12zak28nkv3h48v09"))))
    (build-system gnu-build-system)
...
(define-public ddc-common-attributes
        (package
            ...
            (version "0-b429ceeec65b2e33fb8c228a23391c22eb73bc61")
            (build-system trivial-build-system)
            (source (origin
                (method git-fetch)
                (uri (git-reference
                    (url "https://github.com/ethus3h/ember-information-technology-environment.git")
                    (commit "b429ceeec65b2e33fb8c228a23391c22eb73bc61")))
                (sha256
                (base32
                    "0y2hnq08zz4432sq0svl42kwsqiysnna45xm68j3p7x5mgh0ji29"))
