...
(define-public ember-shared-error-notify
  (package
    ...
    (version "1.1.4.535-dcbadf2914b81819f22fb1803c36ff4402367d94")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "dcbadf2914b81819f22fb1803c36ff4402367d94")))
              (sha256
               (base32
                "0i8g0w2z7ky0rgmm6zhdfxs6lqvcjbbj3dx77y4vhqvzwvfdrsn6"))))
...
(define-public ember-shared-core
  (package
    ...
    (version "1.1.4.535-c8bb4a29751cecab977f4de82adfe2bf12efe093")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "c8bb4a29751cecab977f4de82adfe2bf12efe093")))
              (sha256
               (base32
                "1b5hpqafj1pgdaimh343wyi4a06adcfy3jhibyvnaj6by1brc87c"))))
    (build-system gnu-build-system)
...
(define-public ember-shared-main
  (package
    ...
    (version "1.1.4.535-2daacca7a217e7ed83e66e50cd7f3c90b5e3262b")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "2daacca7a217e7ed83e66e50cd7f3c90b5e3262b")))
              (sha256
               (base32
                "0vwa9plvcfg0hnswdk4nxs0aqfz5wgnr0mq87f56f09kwd0f1253"))))
    (build-system gnu-build-system)
...
(define-public ember-shared-extra
  (package
    ...
    (version "1.1.4.535-fa1f379aad4953be936e03c92829de08259f8acc")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "fa1f379aad4953be936e03c92829de08259f8acc")))
              (sha256
               (base32
                "1iylq914hd8n2nr1bls1h16bjqjdrw78bry9ac9ikvmbdvkqrlam"))))
    (build-system gnu-build-system)
...
(define-public ddc-common-attributes
        (package
            ...
            (version "0-5d3134fb6da96a557176a3e557c68a977fbed778")
            (build-system trivial-build-system)
            (source (origin
                (method git-fetch)
                (uri (git-reference
                    (url "https://github.com/ethus3h/ember-information-technology-environment.git")
                    (commit "5d3134fb6da96a557176a3e557c68a977fbed778")))
                (sha256
                (base32
                    "0lkw5c006zwfsm4gqhb7hymm7rkf1447d9n60r7aacs5qvbxnz6j"))
