...
; generateGuixPackaging ddc-slow; generateAndTestGuixPackaging ddc-fast
...
(define-public ember-shared-error-notify
  (package
    ...
    (version "1.1.4.585-89215ddc03ef453c6110472e9b285e759d463f56")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "89215ddc03ef453c6110472e9b285e759d463f56")))
              (sha256
               (base32
                "0ipib5li7y9jhs7b76ashkhc6h89ivhl6328lypydzqrxsg04ndb"))))
...
(define-public ember-shared-core
  (package
    ...
    (version "1.1.4.585-b50102d21e3293a4e0a32b4c9d3faea43bbda5ff")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "b50102d21e3293a4e0a32b4c9d3faea43bbda5ff")))
              (sha256
               (base32
                "0iipsp0w12syczrv7n0amn4z3vchi4111k8myjl9pds75pxfv995"))))
    (build-system gnu-build-system)
...
(define-public ember-shared-main
  (package
    ...
    (version "1.1.4.585-30ce3b414700889d6d784455238950cdebb46df9")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "30ce3b414700889d6d784455238950cdebb46df9")))
              (sha256
               (base32
                "077m90vsbkd331y4pd4sfdhwkzf46613pxy5jb9fs15dn18wb5dy"))))
    (build-system gnu-build-system)
...
(define-public ember-shared-extra
  (package
    ...
    (version "1.1.4.585-33bb859d151c16c99c1dcfbd4bf37ff34f0d494c")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "33bb859d151c16c99c1dcfbd4bf37ff34f0d494c")))
              (sha256
               (base32
                "02swlxhbijcsr1q39nq9xdc6b382w5ydxlbgq17m7wpz07acd0p3"))))
    (build-system gnu-build-system)
...
(define-public crystallize
  (package
    (name "crystallize")
    (version "3.1.2.5.14.399-1cc4d30a25a1e7656bedaf761e0592f777c4aaed")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/crystallize.git")
                (commit "1cc4d30a25a1e7656bedaf761e0592f777c4aaed")))
              (sha256
               (base32
                "18q9ki209rqanxcxhg4bbc2b8sng419w84226cmbiyw805c2mvmj"))))
    (build-system gnu-build-system)
    (propagated-inputs `(
...
(define-public ddc-common-attributes
    (package
        ...
        (version "1.1.4.585-000d635008095af276766bab2fa8f2355eead4b2")
        (build-system trivial-build-system)
        (source (origin
            (method git-fetch)
            (uri (git-reference
                (url "https://github.com/ethus3h/ember-information-technology-environment.git")
                (commit "000d635008095af276766bab2fa8f2355eead4b2")))
            (sha256
            (base32
                "1pj9yzfjzp8hv7irwvgr10v6dwjz4870nkz1rp0g3h1azbjz609g"))
...
(define-public ddc-common-attributes-slow
    (package
        ...
        (version "1.1.4.585-aa73c68efa31ee60c5221068d74d41db472a56bd")
        (source (origin (inherit (package-source ddc-common-attributes))
            (uri (git-reference
                (url "https://github.com/ethus3h/ember-information-technology-environment.git")
                (commit "aa73c68efa31ee60c5221068d74d41db472a56bd")))
            (sha256
            (base32
                "049s3296jb8y6kx1b9vdm3mr58509ns845lc3m6kaq0vrbmsi7z1"))
        ))
    )
)
