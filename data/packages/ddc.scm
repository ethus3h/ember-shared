...
(define-public ember-shared-error-notify
  (package
    ...
    (version "1.1.4.534-ed70bac6cdf220b766559daf4568ba25ae02c193")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "ed70bac6cdf220b766559daf4568ba25ae02c193")))
              (sha256
               (base32
                "1hdsmrs75mjwmnpy3i3axwzjsgpd91kds1sqk7c4pmvi76nljfjq"))))
...
(define-public ember-shared-core
  (package
    ...
    (version "1.1.4.534-ff077009f233bd75742e912c1ebde1d64c971374")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "ff077009f233bd75742e912c1ebde1d64c971374")))
              (sha256
               (base32
                "1x371l75l1s8d5z0j9cr9arwwcq0sjawa9zsria6ycn66g7bvy8b"))))
    (build-system gnu-build-system)
...
(define-public ember-shared-main
  (package
    ...
    (version "1.1.4.534-c40a7c3784ff6b79f7b1cd825eab2fe7828ae8ec")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "c40a7c3784ff6b79f7b1cd825eab2fe7828ae8ec")))
              (sha256
               (base32
                "1k5h5is5in4hi001q32x8844qsgfv8rahibv0bv9rf4m7mbshp75"))))
    (build-system gnu-build-system)
...
(define-public ember-shared-extra
  (package
    ...
    (version "1.1.4.533-1ccb4d647bda08179064787688aea0c9277bbd1f")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "1ccb4d647bda08179064787688aea0c9277bbd1f")))
              (sha256
               (base32
                "0amkdga7v3bwwgqsdlhm8xaaa007gybkp0gvmvd48mwa7d0wy7cs"))))
    (build-system gnu-build-system)
...
(define-public ddc-common-attributes
        (package
            ...
            (version "0-9da22ede8c432c87dd15b8be8c3ca9a617630079")
            (build-system trivial-build-system)
            (source (origin
                (method git-fetch)
                (uri (git-reference
                    (url "https://github.com/ethus3h/ember-information-technology-environment.git")
                    (commit "9da22ede8c432c87dd15b8be8c3ca9a617630079")))
                (sha256
                (base32
                    "0dh8lhlcvll2j2q0jkfnsv06yz6srs9sn3n7a5w21hx2xs15013s"))
