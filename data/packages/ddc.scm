...
(define-public ember-shared-error-notify
  (package
    ...
    (version "1.1.4.537-bfc60ffb710b35327a7c214ea24ee33e6e0b4631")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "bfc60ffb710b35327a7c214ea24ee33e6e0b4631")))
              (sha256
               (base32
                "0dfzbzwwvxpc1p3jhbc8b2lb50y08x7pkk69wyxblpmprjk179iw"))))
...
(define-public ember-shared-core
  (package
    ...
    (version "1.1.4.537-56b6ec1df18d7d14b7b3f8876357cd161a50de89")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "56b6ec1df18d7d14b7b3f8876357cd161a50de89")))
              (sha256
               (base32
                "1iz1k3r9md0j8cd7s1w78q56230f2qpz9pgc8975klmnpq4h2rn6"))))
    (build-system gnu-build-system)
...
(define-public ember-shared-main
  (package
    ...
    (version "1.1.4.537-fd8be61351613ce03a56e4bad3545a3b076ff8c8")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "fd8be61351613ce03a56e4bad3545a3b076ff8c8")))
              (sha256
               (base32
                "0fdfwpbgws02p2syb37mn03k6wnaby3n86lfl6fbsl0v0z0c2ngw"))))
    (build-system gnu-build-system)
...
(define-public ember-shared-extra
  (package
    ...
    (version "1.1.4.537-90073f9e9f10f9c782fa9044491359ae38e4970b")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                (url "https://github.com/ethus3h/ember-shared.git")
                (commit "90073f9e9f10f9c782fa9044491359ae38e4970b")))
              (sha256
               (base32
                "17nj2d11k3mvqpwcjnwklfwvv7b4sj7ch59nxadjgxxgjnh92vax"))))
    (build-system gnu-build-system)
...
(define-public ddc-common-attributes
        (package
            ...
            (version "0-7a62752cad843a3cb1445661146a41ed92fae724")
            (build-system trivial-build-system)
            (source (origin
                (method git-fetch)
                (uri (git-reference
                    (url "https://github.com/ethus3h/ember-information-technology-environment.git")
                    (commit "7a62752cad843a3cb1445661146a41ed92fae724")))
                (sha256
                (base32
                    "147p4giiv000w8f7h25151mkz9bwnri6agsh5s0bl4hy0r5gjg49"))
